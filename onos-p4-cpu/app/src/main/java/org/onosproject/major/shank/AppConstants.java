...
public class AppConstants {
    ...
    public static final String APP_NAME = "org.onosproject.major-shank";
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("org.onosproject.major-shank");
    ...
    public static final int ETHER_TYPE_REC = 0x819;
}
