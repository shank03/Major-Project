...
@Service
@Command(scope = "onos", name = "stop-rec", description = "Stop recording CPU usage along the path of mentioned src and dst")
public class StopRecorder extends AbstractShellCommand {
    ...
    protected void doExecute() {
        ...
        metricsComponent.stopRecording(srcHost, dstHost);
        print("Stopped recording CPU for %s - %s", srcHost.id(), dstHost.id());
    }
}
