...
public class InterpreterImpl extends AbstractHandlerBehaviour
    ...
    private static final Map<Criterion.Type, String> CRITERION_MAP =
            new ImmutableMap.Builder<Criterion.Type, String>()
                    ...
                    .put(Criterion.Type.ARP_SHA, "hdr.arp.senderHwAddr")
                    .put(Criterion.Type.ARP_SPA, "hdr.arp.senderIpAddr")
                    .put(Criterion.Type.ARP_THA, "hdr.arp.targetHwAddr")
                    .put(Criterion.Type.ARP_TPA, "hdr.arp.targetIpAddr")
                    .build();
