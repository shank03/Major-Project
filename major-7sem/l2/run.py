...
class Runner():
    ...
    def configure_hosts(self):
        self.net['h1'].cmd("ip route add 192.168.1.0/24 dev eth0")
        self.net['h1'].cmd("arp -i eth0 -s 192.168.1.3 00:00:00:00:02:00")
        
        self.net['h2'].cmd("ip route add 192.168.1.0/24 dev eth0")
        self.net['h2'].cmd("arp -i eth0 -s 192.168.1.2 00:00:00:00:01:00")
...
Runner(p4_list=['l2'], switches=['s1']).run()
